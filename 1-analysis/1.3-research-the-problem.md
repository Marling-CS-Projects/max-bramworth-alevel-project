...
Metal Gear Rising: Revengence is a fast-paced hack and slash that deviates significantly from the rest of the metal gear series, which focuses mainly on stealth based gameplay. Metal Gear Rising (MGR) was developed in 2013 by \[devs] and published by \[publisher] for PlayStation and PC. It features a high-tech theme and has many features in in order to make the player feel awesome.
