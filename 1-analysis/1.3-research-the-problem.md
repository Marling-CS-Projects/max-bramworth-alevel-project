...
Players also receive a grade rating their performance at the end of every stage. This grade is based of factors, all of which directly rely on the player's skill alone, and instead of punishing the player for playing in a way that 'cheeses' encounters or is overly cowardly, it rewards those who play aggressively and takes risks - which is often the most fun way to play the game.
...
| Feature                                  | Justification |
| ---------------------------------------- | ------------- |
| When sundowner uses bad language >:((((( | not cool bro  |
|                                          |               |
|                                          |               |
{% endtab %}
{% endtabs %}
