...
In order to make the player feel like a robot ninja, \[dev]s used a variety of tricks to add a sense of speed and power to all actions. All animations are given a generous dosage of motion blur which makes them feel faster and shows their path of travel, adding weight to the motions causing them to feel more powerful.
