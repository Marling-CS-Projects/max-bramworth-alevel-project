...
In order to make the player feel like a robot ninja, Platinum used a variety of tricks to add a sense of speed and power to all actions. All animations are given a generous dosage of motion blur which makes them feel faster and shows their path of travel, adding weight to the motions causing them to feel more powerful. Raiden's attacks take up massive amounts of space on the screen, arcing across it to make them feel powerful.&#x20;
